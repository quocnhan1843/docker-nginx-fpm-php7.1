...
class Page
{
    ...
    ?>
        <!-- page header -->
        <header>
            <img src="../public/php-logo.png" alt="TLA logo" height="70" width="70" />
    ...
    public function DisplayButton($name, $url, $active=true)
    {
        if ($active) { ?>
            <div class="menuitem">
            <a href="<?=$url?>">
            <img src='../public/php-logo.png' alt="" height="20" width="20" />
            ...
            <div class="menuitem">
            <img src="../public/php-logo.png" height="50" width="50">
            <span class="menutext"><?=$name?></span>
            </div>
            <?php
        }
